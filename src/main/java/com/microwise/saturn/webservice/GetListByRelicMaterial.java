...
@XmlRootElement(name = "GetListByRelicMaterial")
public class GetListByRelicMaterial {

    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar startDate;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar endDate;
    @XmlElementRef(name = "relicMaterial", namespace = "http://tempuri.org/", type = JAXBElement.class)
