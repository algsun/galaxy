...
public class LogicGroupPO {
     ...
     *
     */
    private List<SensorInfoPO> sensorInfoVOList;
     ...
     * @date 2012-11-28
     */
    public LogicGroupPO(String logicGroupName, LogicGroupPO parent,
    ...
    public LogicGroupPO getParent() {
        return parent;
    }

    public void setParent(LogicGroupPO parent) {
        this.parent = parent;
    }
    ...
    public List<SensorInfoPO> getSensorInfoVOList() {
        return sensorInfoVOList;
    }

    public void setSensorInfoVOList(List<SensorInfoPO> sensorInfoVOList) {
