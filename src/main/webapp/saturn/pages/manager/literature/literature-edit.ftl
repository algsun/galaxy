...
<div class="container">
    <div class="row">
        <form id="literature-form" class="form-horizontal" action="manager/literatures/${literature.id}" method="post">
            <fieldset>
                <legend>
                    添加文献资料
                </legend>
                <input name="id" type="hidden" value="${literature.id}"/>
                <input name="createTime" type="hidden" value="${literature.createTime?string("yyyy-MM-dd")}"/>
                <input name="createBy" type="hidden" value="${literature.createBy}"/>
                <input name="siteId" type="hidden" value="${literature.siteId}"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="catalog" id="catalog">
                            <option value="1" <#if literature.catalog?number==1>selected="selected"</#if>>论文</option>
                            <option value="2" <#if literature.catalog?number==2>selected="selected"</#if>>著作</option>
                            <option value="3" <#if literature.catalog?number==3>selected="selected"</#if>>其他</option>
                        </select>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="author" name="author" value="${literature.author!}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="Wdate" id="publicDate" name="publicDate"
                               ...
                               value="${literature.publicDate?string("yyyy-MM-dd")}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="magazine" name="magazine" value="${literature.magazine!}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="periodical" name="periodical" value="${literature.periodical!}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="keywords" name="keywords" value="${literature.keywords!}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="title" name="title" value="${literature.title!}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="summary" name="summary">${literature.summary!}</textarea>
