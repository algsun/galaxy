...
<div class="container">
    <div class="row">
        <form class="form-horizontal" id="task-record-form" action="task_records/do_update" method="post">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="important" name="important">
                            <option <#if taskRecordVO.important == 1> selected="selected" </#if> value="1">否</option>
                            <option <#if taskRecordVO.important == 0> selected="selected" </#if> value="0">是</option>
                        </select>
                        <span id="title-input-help" class="help-inline"></span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="recordUserName" id="recordUserName" value="${taskRecordVO.recordUserName!}"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <#--name="handleResult"-->
                                  readonly="readonly">${taskRecordVO.handleResult!}</textarea>
                        <span id="title-input-help" class="help-inline"></span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" readonly="readonly" value="${taskRecordVO.handleUserName!}"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <#--name="handleDate"-->
                               value="<#if taskRecordVO.handleDate??>${taskRecordVO.handleDate?string('yyyy-MM-dd')}</#if>"
                               readonly="readonly"/>
