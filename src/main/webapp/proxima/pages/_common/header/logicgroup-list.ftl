...
<#--用户归属站点 (多余的判断是过滤超级管理员)-->
    ...
    <li class="divider"></li>
    <li><a href="#" onclick="javascript: App('common').header.chooseLogicGroup('proxima'); return false;">其它站点...</a></li>
    <li><a href="#" onclick="javascript: SWITCH_MAP.logicGroupMap('proxima'); return false;">站点地图</a></li>
</ul>
...
如果是行政站点跳转到系统管理
 -->
    <#if logicGroup.site??>
        <#return "../blackhole/switchLogicGroup.action?forward=/proxima/&logicGroupId=${logicGroup.id}">
    <#else>
