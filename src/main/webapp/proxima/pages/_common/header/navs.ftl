...
<#--归属站点-->
<#if security.atHome()>
    <@topnav_topnav Session["subsystemPrivileges"].get(3?int)  currentTopPrivilege></@topnav_topnav>
<#else>
<#-- 其他站点 -->
    <@topnav_topnav Session["subsystemPrivilegesOfGuest"].get(3?int)  currentTopPrivilege></@topnav_topnav>
</#if>
</ul>
