...
<#include "../_common/common-head.ftl">
    <title>${locale.getStr("proxima.ftp.edit.title")} - ${locale.getStr("proxima.common.systemName")}</title>
...
<@subNavs "proxima:ftp:update"></@subNavs>
<#-- 消息提示 -->
...
<#if ftpProfile??>
    <div class="row">
        <div class="span12">
            <form class="form-horizontal" id="ftp-form" action="updateFTP.action" method="post">
                <fieldset>
                    <legend>
                    ${locale.getStr("proxima.ftp.edit.title")}
                    </legend>
                    <input name="id" type="hidden" value="${ftpProfile.id!}"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="name" name="name" placeholder="名称" value="${ftpProfile.name!}"
                                   maxlength="50">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="ip" name="ip" value="${ftpProfile.host!}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="port" name="port" value="${(ftpProfile.port!)?c}">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="userName">
                            <em class="required">*</em>${locale.getStr("proxima.ftp.userName")}
                        </label>

                        <div class="controls">
                            <input type="text" id="userName" name="userName" value="${ftpProfile.username!}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" id="password" name="password" value="${ftpProfile.password!}">
