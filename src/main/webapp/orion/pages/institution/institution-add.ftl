...
<div id="gcontent" class="container m-t-50">
    <form class="form-horizontal" id="institution_form" action="institution/do_add" method="post" >
        <fieldset>
            <legend>
                添加单位
            </legend>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" name="institution.name">
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="seat" name="institution.seat">
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="mailing" name="institution.mailing">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="zipcode" name="institution.zipcode">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="qualification" name="institution.qualification">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="code" name="institution.code">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="institution.institutionType" id="institutionType">
                        <option value="0">设计单位</option>
                        <option value="1">收藏单位</option>
                        <option value="2">修复单位</option>
                    </select>
                </div>
            </div>
