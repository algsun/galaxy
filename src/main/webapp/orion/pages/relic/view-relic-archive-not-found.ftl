                ...
                <div id="total-code-input" class="input-append">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="disabled" href="relicCard.action?totalCode=${totalCode}"><i
                                    class="icon-list-alt"></i> 藏品卡</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#total-code-go-button").click(function () {
            ...
            location.href = "culturalRelicArchives.action?totalCode=" + $("#total-code-input > input").val();
        });
    });
    function keyEnter() {
