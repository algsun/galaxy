<table border="1px" style="border:2px #000 solid;">
    ...
    <tr>
        ...
        <td colspan="17">${(repairRecord.situation.size)!}</td>
    </tr>
    <tr>
        <td colspan="3">质量<span class="careful">(g)</span></td>
        <td colspan="17">${(repairRecord.situation.weight)!}</td>
    </tr>
    <tr>
        <td colspan="3">修复后质量<span class="careful">(g)</span></td>
        <td colspan="17">${(repairRecord.situation.repairedSize)!}</td>
    </tr>
    <tr>
        <td colspan="3">画轴</td>
        <td colspan="17">${(repairRecord.situation.kakemono)!}</td>
    </tr>
    <tr>
        <td colspan="3">装裱样式</td>
        <td colspan="7">${(repairRecord.situation.frameStyle)!}</td>
        <td colspan="3">装裱用料</td>
        <td colspan="7">${(repairRecord.situation.frameMaterial)!}</td>
    </tr>
    <tr>
        <td colspan="3">包首</td>
        <td colspan="17">${(repairRecord.situation.packHead)!}</td>
    </tr>
    <tr>
        <td colspan="3">照片</td>
        <td colspan="17">
    ...
    <tr>
        ...
        <td colspan="17">
            <#if repairRecord.relic.relicPropertyMap.describe??>
                  ${repairRecord.relic.relicPropertyMap.describe.propertyValue!}
            </#if>
        </td>
    </tr>
    <tr>
