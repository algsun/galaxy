        ...
        <form class="form-horizontal ">
            <div class="control-group">
                ...
                <div class="form-actions">
                    <button type="button" onclick="" class="btn btn-primary" id="draw-register-submit">保存</button>
                    <button type="button" class="btn m-l-20" onclick="javascript:history.go(-1);" >返回</button>
                </div>
            </div>
        </form>
    </fieldset>
