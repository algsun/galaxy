...
<#--用户归属站点 (多余的判断是过滤超级管理员)-->
    ...
    <li class="divider"></li>
    <li><a href="#" onclick="javascript: App('common').header.chooseLogicGroup('orion'); return false;">其它站点...</a></li>
    <li><a href="#" onclick="javascript: SWITCH_MAP.logicGroupMap('orion'); return false;">站点地图</a></li>
</ul>
