...
<@messageTooltip/>
    ...
    <fieldset>
        <legend>
            <a class="go-back" href="queryStockInAndOut.action"><i class="mw-icon-prev"></i>出库申请单调整</a>
        </legend>
    </fieldset>

<#include "stock-helper.ftl">

    <form action="doAdjustStockOut.action" method="post">
        <input type="hidden" name="taskId" value="${taskId}"/>
        <input type="hidden" name="outEventId" value="${outEventId}"/>
        <input type="hidden" name="outEvent.id" value="${outEvent.id}"/>
        <input type="hidden" name="outEvent.user.id" value="${outEvent.user.id}"/>
        <input type="hidden" name="outEvent.siteId" value="${outEvent.siteId}"/>
                        ...
                        <div class="span4">
                            <div class="form-inline">
                                ...
                                <lable class="radio inline"><input type="radio" name="outEvent.outBound" value="false"
                                                                   <@checked false, outEvent.outBound/>/>否
                                </lable>
                                <lable class="radio inline"><input type="radio" name="outEvent.outBound" value="true" <@checked true, outEvent.outBound/>/>是
                                </lable>
                            </div>
        ...
        <div class="row">
            ...
            <div class="span5">
                ...
                <div class="form-inline">
                    <label>总数：</label>
                    <span id="relicCount">${outEvent.eventRelics?size}</span>
                </div>
            </div>
        </div>
        ...
        <div class="row m-t-20">
            ...
            <div class="span5" style="max-height: 380px; overflow: auto;">
                <table id="chosenRelicsTable" class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" value="${eventRelic.relic.id}"/>
                            <input type="hidden" name="relicIds" value="${eventRelic.relic.id?c}"/>
                        </td>
