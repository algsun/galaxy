        ...
        <div class="span12">
            <form id="schemeForm" class="form-horizontal" action="schemes/saveOrUpdateScheme"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="scheme.schemeId" id="schemeId" value="${scheme.schemeId}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="scheme.name" id="name" value="${scheme.name}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="input-medium Wdate" type="text"
                               name="scheme.confirmTime" value="${scheme.confirmTime?string("yyyy-MM-dd")}"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="scheme.confirmNum" id="confirmNum" value="${scheme.confirmNum}">
...
<select style="width: 150px" name="scheme.institution.id" id="institutionId">
    <#if institutions?size != 0>
        <option value="0">--请选择--</option>
        <#list institutions as institution>
            <option value="${institution.id}" <#if institution.id== scheme.institution.id>selected="true"</#if>>${institution.name}</option>
        </#list>
    </#if>
</select>
</#macro>