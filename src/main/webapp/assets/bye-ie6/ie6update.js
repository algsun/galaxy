/*为了减小js体积，license放到http://ie6update-cn.googlecode.com/svn/trunk/license/license.txt 请观摩*/
...
(function($) {
    ...
    $.fn.activebar.defaults = {
        ...
        'fontSize': '11px',
        'icons_path' : 'images/',
        'url': 'http://www.microsoft.com/china/windows/internet-explorer/default.aspx',
        'preload': true
    };
...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Internet Explorer缺少必要的更新来浏览此网页。点击这里访问Windows Update获取更新...')
