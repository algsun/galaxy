...
<div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle t-d-none" style="color: ${_subsystem_color(activeSubsystemCode)};"
...
<#macro _subsystem_item_view subsystem, active = false>
    <#local subsystemCode = subsystem.subsystemCode>
    <a class="dropdown-item subsystemHead <#if active>active</#if>" href="../${subsystemCode}/" <#if active>style="color:white;"</#if>><img
            src="../common/images/subsystems/${subsystemCode}-small.png" class="subsystem-head-icon"> ${subsystem.subsystemName} </a>
</#macro>
