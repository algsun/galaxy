...
<#--归属站点-->
<#if security.atHome()>
    <@subsystem_navs Session["subsystemPrivileges"].get(5?int), currentTopPrivilege></@subsystem_navs>
<#else>
<#-- 访客权限 -->
    <@subsystem_navs Session["subsystemPrivilegesOfGuest"].get(5?int), currentTopPrivilege></@subsystem_navs>
</#if>
