...
var REALTIME_DATA_UTIL = {
    ...
    baseAttrView: function ($td, dataType, dataRow, serverTime) {
        if (dataType == "stamp") {
            ...
            $td.html("<a href='device/" + dataRow["locationId"] + "/detail'>" + nodeName + "</a>").attr("title", dataRow["locationId"]);
            ...
            $td.text(dataRow[dataType] == null ? message.zoomName : dataRow[dataType]);
        }
    },
    // 时间处理
