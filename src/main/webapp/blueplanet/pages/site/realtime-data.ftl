<#--
  ...
  -->
<#assign title = locale.getStr("blueplanet.common.realtimeDataTitle")>
...
<div class="form-inline m-b-10">
    <div class="m-b-10">
        ...
        <button id="filter-btn"
                class="btn btn-small btn-success hide">${locale.getStr("blueplanet.realtimeData.search")}</button>
        <a id="cancel-filter-btn" class="btn btn-small hide"
           href="site/realtime-data?isShowFilters=false">${locale.getStr("blueplanet.realtimeData.reset")}</a>
...
<div id="table-container" style="overflow: auto;min-height: 200px; height: 500px;">
    <div id="real_time_div">
        <table id="real_time_data_table_mould"
            ...
            <thead>
            <tr>
                <th data-dead='1' data-type='zoneName' style='vertical-align: middle;'>
                    <span>${locale.getStr("common.zone")}</span></th>
                <th data-dead='1' data-type='locationName' style='vertical-align: middle;'>
                    <span>${locale.getStr("common.location")}</span></th>
                <th data-dead='1' data-type='state' style='vertical-align: middle;'>
                    <span>${locale.getStr("blueplanet.common.status")}</span></th>
...
<script type="text/javascript">
    $(function () {
        ...
        //监测指标获取 初始化实时数据表头
        var realtimeDataFilterUrl = "site/realtime-data-filter";
        var realtimeDataUrl = "site/realtime-data.json";
        var sensorinfoesUrl = "site/sensorinfoes.json";
