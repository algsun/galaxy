...
<@subNavs "blackhole:post:edit"></@subNavs>

<#include "../_common/message-tooltip.ftl" >

    <div class="row">
        <div class="span12">
            <form id="post-form" class="form-horizontal" action="doUpdatePost.action" method="post">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="radio inline">
                                <input type="radio" name="scope" value="1" <@checked 1, post.scope/>/> 公共
                            </label>
                            <label class="radio inline">
                                <input type="radio" name="scope" value="2" <@checked 2, post.scope/>/> 内部
                            </label>
                        ...
                        <div class="controls">
                            <div>
                                <input class="input-medium Wdate"  type="text" id="createDate" name="createDate"
                                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${post.createDate?string("yyyy-MM-dd HH:mm:ss")!}"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xxlarge" type="text" name="title" value="${post.title?html}" maxlength="50"/>
                            <span class="help-inline red"></span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="input-xxlarge" rows="10" id="content"
