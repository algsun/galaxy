...
<!-- 系统图片 END -->
<#-- 加载模版-->
<div id="gcontent " class="container background4" style="min-height: 300px;width: 960px">

    <div class="background1" style="padding-left: 20px;color: #ffffff">
    ...
    <ul style="list-style-type:circle;">
        ...
        <#--elippsis 去掉 该class  避免 li 格式问题-->
            <a href="viewPost.action?id=<%= item.id %>&scope=-1" class=""
               style="width:430px; display:inline-block;color: #ffffff;" title="<%= item.title %>"><%= item.title %></a>
                <span class="f-r gray-b" style="font-size:0.8em;color: #ffffff;padding-right: 10px"
...
<div class="row m-t-10">
    <div class="span8 background2">
        <@PublicModule></@PublicModule>
    </div>

    <div class=" span4 background2" style="padding:30px 10px 0px 10px ">
...
<#macro template_2>
<div class="row m-t-10">
    <div class="span12 background2" style="padding: 10px 10px 0px 10px">
        <@subsystemsForUpAndDowd></@subsystemsForUpAndDowd>
    </div>
    <div class="span12 background2" style="padding: 10px">
        <@PublicModule></@PublicModule>
    </div>
...
<div>
    <div>
        ...
        <div class="  m-b-10 background3" id="myTask" style="overflow:hidden;">
            <h4 class="m-v-0 f-n yahei-font f-l" style="color:#ffffff;padding: 10px">我的任务</h4>
            <a class="f-r gray-b background1" style="font-size:1.0em ;padding:10px 20px 10px 20px;color: #ffffff;"
               href="listTask.action">更多...</a>
        </div>
    ...
    <div>
        ...
        <div class="m-t-10 m-b-10 background3" style="overflow: hidden;margin: 0px;">
            <div>
                <h4 class="m-v-0 f-n yahei-font f-l" style="color:#ffffff;padding: 10px">新闻</h4>
            </div>
            ...
            <a href="../${subsystem.subsystemCode}/" style="border: 0px;padding: 0px"
               class="subsystemNail thumbnail ${subsystem.subsystemCode} t-d-none shadow1 <#if !isBaseSite && subsystem.subsystemId != 9>disable</#if>">
                <div class="caption" style="padding: 0px">
                    <img src="${basePath()}/blackhole/images/mode/mode2/${subsystem.subsystemCode}.png"
