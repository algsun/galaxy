...
<#include "../../_common/common-css.ftl">
    <link rel="stylesheet" type="text/css" href="css/mode/login6.css"/>
</head>
<body>
...
<div class="container-fluid">
    <div class="row-fluid" style="margin-top: 100px;">
        <div class="span5 offset1" style="width: 600px;">
            <div class="row-fluid">
                <div class="span12">
                    <img src="images/mode/mode6/site-name.png" alt=""/>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span12">
                    <img src="images/mode/mode6/site-img.png" class="m-l-50" style="max-width:650px;max-height: 400px; "
                         alt=""/>
                </div>
            </div>
        </div>
